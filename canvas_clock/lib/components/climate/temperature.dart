...
class RenderTemperature
  ...
  void describeSemanticsConfiguration(SemanticsConfiguration config) {
    ...
    config
      ...
      ..label =
          'Thermometer showing a temperature of $_temperature$_unitString, a high of $_high$_unitString, and a low of $_low$_unitString';
  }
  ...
  void _drawTemperature(Canvas canvas, Line1d tube, Line1d lines,
    ...
    final horizontalLine =
        Line1d.fromCenter(center: offset.dx, extent: strokeWidth);
    canvas.drawLine(
