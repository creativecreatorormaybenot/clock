...
class RenderWeatherIcon extends RenderCompositionChild<WeatherCondition,
  ...
  void drawCloudy(Canvas canvas) {
    ...
    _drawCloud(canvas, -radius * indentationFactor / 4,
        -radius * indentationFactor / 18, .8);
    _drawCloud(canvas, radius * indentationFactor / 4,
        -radius * indentationFactor / 8, .8);
    _drawCloud(canvas, 0, 0, 1.3);
    _drawCloud(canvas, -radius * indentationFactor / 4.2,
  ...
  void drawWindy(Canvas canvas) {
    // Primary wind symbol
    _drawWind(canvas, primaryWindColor, 0, radius * indentationFactor / 17, .96,
        2, 1.8, 1);

    // Upper wind symbol
    _drawWind(canvas, secondaryWindColor, radius * indentationFactor / -3,
        radius * indentationFactor / -5, .8, 2, 1.8, 1);

    // Lower wind symbol
    _drawWind(canvas, secondaryWindColor, radius * indentationFactor / -6,
